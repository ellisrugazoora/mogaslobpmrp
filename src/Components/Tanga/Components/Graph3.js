...
function Graph3(props){
    ...
    var finance_table = {
        inv1: {product: "500SN/600N", Qty: data(args).bo1.sum.toFixed(2), Stockholding_period: shp({inv:args.bo1,consrate:args.crbo1}), leadtime: 60, supplier: "KDR",orderdate: orderdate({ hs: shp({inv:args.bo1,consrate:args.crbo1}),mhs:60, lt:60}), paymentDueDate: "TBD"},
        inv2: {product: "150SN", Qty: data(args).bo2.sum.toFixed(2), Stockholding_period: shp({inv:args.bo2,consrate:args.crbo2}),leadtime: 60,supplier: "KDR",orderdate: orderdate({hs: shp({inv:args.bo2,consrate:args.crbo2}), mhs:60, lt:60})},
        inv3: {product: "BS150", Qty: data(args).bo3.sum.toFixed(2), Stockholding_period: shp({inv:args.bo3,consrate:args.crbo3}),leadtime: 60,supplier: "KDR",orderdate: orderdate({hs: shp({inv:args.bo3,consrate:args.crbo3}), mhs:60, lt:60})},
        inv4: {product: "SN80/SN100", Qty: data(args).bo4.sum.toFixed(2), Stockholding_period: shp({inv:args.bo4,consrate:args.crbo4}),leadtime: 60,supplier: "Royal",orderdate: orderdate({hs: shp({inv:args.bo4,consrate:args.crbo4}), mhs:60, lt:60})},
        inv5: {product: "DPK", Qty: data(args).bo5.sum.toFixed(2), Stockholding_period: shp({inv:args.bo5,consrate:args.crbo5}),leadtime: 60,supplier: "Royal",orderdate: orderdate({hs: shp({inv:args.bo5,consrate:args.crbo5}), mhs:60, lt:60})},
