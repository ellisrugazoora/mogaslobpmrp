...
function Graph3(props){
    ...
    var inv_table_data = {
        ...
        inv2: {col1: "150SN", col2: data(args).bo2.sum.toFixed(2), col3: <NumberInp prod="bo2" init={args.bo2} onChange={inv_table} value={args.bo2} />,transit: <NumberInp prod="trbo2" init={args.trbo2} onChange={inv_table} value={args.trbo2} />, consrate:<NumberInp prod="crbo2" init={args.crbo2} onChange={inv_table} value={args.crbo2}/>, hs: shp({inv:args.bo2,consrate:args.crbo2, transit: args.trbo2}),col4: 60,order: orderdate({ hs: shp({inv:args.bo2,consrate:args.crbo2, transit: args.trbo2}),mhs:args.mhs, lt:60,transit: args.trbo2, consrate:args.crbo2}),col5: (args.bo2 - data(args).bo2.sum).toFixed(2)},
        inv3: {col1: "BS150", col2: data(args).bo3.sum.toFixed(2), col3: <NumberInp prod="bo3" init={args.bo3} onChange={inv_table} value={args.bo3} />,transit: <NumberInp prod="trbo3" init={args.trbo3} onChange={inv_table} value={args.trbo3} />, consrate:<NumberInp prod="crbo3" init={args.crbo3} onChange={inv_table} value={args.crbo3}/>,hs: shp({inv:args.bo3,consrate:args.crbo3, transit: args.trbo3}),col4: 60,order: orderdate({ hs: shp({inv:args.bo3,consrate:args.crbo3, transit: args.trbo3}),mhs:args.mhs, lt:60,transit: args.trbo3, consrate:args.crbo3}),col5: (args.bo3 - data(args).bo3.sum).toFixed(2)},
        inv4: {col1: "SN80/SN100", col2: data(args).bo4.sum.toFixed(2), col3: <NumberInp prod="bo4" init={args.bo4} onChange={inv_table} value={args.bo4} />,transit: <NumberInp prod="trbo4" init={args.trbo4} onChange={inv_table} value={args.trbo4} />, consrate:<NumberInp prod="crbo4" init={1} onChange={inv_table} value={args.crbo4}/>, hs: shp({inv:args.bo4,consrate:args.crbo4, transit: args.trbo4}),col4: 60,order: orderdate({ hs: shp({inv:args.bo4,consrate:args.crbo4, transit: args.trbo4}),mhs:args.mhs, lt:60,transit: args.trbo4, consrate:args.crbo4}),col5: (args.bo4 - data(args).bo4.sum).toFixed(2)},
        ...
        inv10: {col1: "VII", col2: data(args).ad5.sum.toFixed(2), col3: <NumberInp prod="ad5" init={args.ad5} onChange={inv_table} value={args.ad5} />,transit: <NumberInp prod="trad5" init={args.trad5} onChange={inv_table} value={args.trad5} />, consrate:<NumberInp prod="crad5" init={args.crad5} onChange={inv_table} value={args.crad5}/>, hs: shp({inv:args.ad5,consrate:args.crad5, transit: args.trad5}),col4: 40,order: orderdate({ hs: shp({inv:args.ad5,consrate:args.crad5, transit: args.trad5}),mhs:args.mhs, lt:40,transit: args.trad5, consrate:args.crad5}),col5: (args.ad5 - data(args).ad5.sum).toFixed(2)},
        inv11: {col1: "MONO PA EO", col2: data(args).ad6.sum.toFixed(2), col3: <NumberInp prod="ad6" init={args.ad6} onChange={inv_table} value={args.ad6} />,transit: <NumberInp prod="trad6" init={args.trad6} onChange={inv_table} value={args.trad6} />, consrate:<NumberInp prod="crad6" init={args.crad6} onChange={inv_table} value={args.crad6}/>, hs: shp({inv:args.ad6,consrate:args.crad6, transit: args.trad6}),col4: 40,order: orderdate({ hs: shp({inv:args.ad6,consrate:args.crad6, transit: args.trad6}),mhs:args.mhs, lt:40,transit: args.trad6, consrate:args.crad6}),col5: (args.ad6 - data(args).ad6.sum).toFixed(2)},
        inv12: {col1: "4T PA PEO", col2: data(args).ad7.sum.toFixed(2), col3: <NumberInp prod="ad7" init={args.ad7} onChange={inv_table} value={args.ad7} />,transit: <NumberInp prod="trad7" init={args.trad7} onChange={inv_table} value={args.trad7} />, consrate:<NumberInp prod="crad7" init={args.crad7} onChange={inv_table} value={args.crad7}/>, hs: shp({inv:args.ad7,consrate:args.crad7, transit: args.trad7}),col4: 40,order: orderdate({ hs: shp({inv:args.ad7,consrate:args.crad7, transit: args.trad7}),mhs:args.mhs, lt:40,transit: args.trad7, consrate:args.crad7}),col5: (args.ad7 - data(args).ad7.sum).toFixed(2)},
        inv13:{col1: "ATF PA", col2: data(args).ad8.sum.toFixed(2), col3: <NumberInp prod="ad8" init={args.ad8} onChange={inv_table} value={args.ad8} />,transit: <NumberInp prod="trad8" init={args.trad8} onChange={inv_table} value={args.trad8} />, consrate:<NumberInp prod="crad8" init={args.crad8} onChange={inv_table} value={args.crad8}/>, hs: shp({inv:args.ad8,consrate:args.crad8, transit: args.trad8}),col4: 40,order: orderdate({ hs: shp({inv:args.ad8,consrate:args.crad8, transit: args.trad8}),mhs:args.mhs, lt:40,transit: args.trad8, consrate:args.crad8}), col5: (args.ad8 - data(args).ad8.sum).toFixed(2)},
        inv14:{col1: "2T PA", col2: data(args).ad9.sum.toFixed(2), col3: <NumberInp prod="ad9" init={args.ad9} onChange={inv_table} value={args.ad9} />,transit: <NumberInp prod="trad9" init={args.trad9} onChange={inv_table} value={args.trad9} />, consrate:<NumberInp prod="crad9" init={args.crad9} onChange={inv_table} value={args.crad9}/>, hs: shp({inv:args.ad9,consrate:args.crad9, transit: args.trad9}),col4: 40,order: orderdate({ hs: shp({inv:args.ad9,consrate:args.crad9, transit: args.trad9}),mhs:args.mhs, lt:40,transit: args.trad9, consrate:args.crad9}), col5: (args.ad9 - data(args).ad9.sum).toFixed(2)},
        inv15:{col1: "HYA", col2: data(args).ad10.sum.toFixed(2), col3: <NumberInp prod="ad10" init={args.ad10} onChange={inv_table} value={args.ad10} />,transit: <NumberInp prod="trad10" init={args.trad10} onChange={inv_table} value={args.trad10} />, consrate:<NumberInp prod="crad10" init={args.crad10} onChange={inv_table} value={args.crad10}/>, hs: shp({inv:args.ad10,consrate:args.crad10, transit: args.trad10}),col4: 40,order: orderdate({ hs: shp({inv:args.ad10,consrate:args.crad10, transit: args.trad10}),mhs:args.mhs, lt:40,transit: args.trad10, consrate:args.crad10}),col5: (args.ad10 - data(args).ad10.sum).toFixed(2)},
        inv16:{col1: "DYE", col2: data(args).ad11.sum.toFixed(2), col3: <NumberInp prod="ad11" init={args.ad11} onChange={inv_table} value={args.ad11} />,transit: <NumberInp prod="trad11" init={args.trad11} onChange={inv_table} value={args.trad11} />, consrate:<NumberInp prod="crad11" init={args.crad11} onChange={inv_table} value={args.crad11}/>, hs: shp({inv:args.ad11,consrate:args.crad11, transit: args.trad11}),col4: 40,order: orderdate({ hs: shp({inv:args.ad11,consrate:args.crad11, transit: args.trad11}),mhs:args.mhs, lt:40,transit: args.trad11, consrate:args.crad11}),col5: (args.ad11 - data(args).ad11.sum).toFixed(2)},
        inv17:{col1: "TURB", col2: data(args).ad12.sum.toFixed(2), col3: <NumberInp prod="ad12" init={args.ad12} onChange={inv_table} value={args.ad12} />,transit: <NumberInp prod="trad12" init={args.trad12} onChange={inv_table} value={args.trad12} />, consrate:<NumberInp prod="crad12" init={args.crad12} onChange={inv_table} value={args.crad12}/>, hs: shp({inv:args.ad12,consrate:args.crad12, transit: args.trad12}),col4: 40,order: orderdate({ hs: shp({inv:args.ad12,consrate:args.crad12, transit: args.trad12}),mhs:args.mhs, lt:40,transit: args.trad12, consrate:args.crad12}),col5: (args.ad12 - data(args).ad12.sum).toFixed(2)}
    };
    var finance_table = {
        inv1: {product: "500SN/600N", Qty: data(args).bo1.sum.toFixed(2), /*Stockholding_period: shp({inv:args.bo1,consrate:args.crbo1}), */leadtime: 60, supplier: "KDR",orderdate: orderdate({ hs: shp({inv:args.bo1,consrate:args.crbo1, transit: args.trbo1}),mhs:args.mhs, lt:60,transit: args.trbo1, consrate:args.crbo1}), paymentDueDate: paymentDue("KDR", "inv1", "order"), amountDue: amountDue("bo1",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv2: {product: "150SN", Qty: data(args).bo2.sum.toFixed(2), /*Stockholding_period: shp({inv:args.bo2,consrate:args.crbo2}),*/leadtime: 60,supplier: "KDR",orderdate: orderdate({ hs: shp({inv:args.bo2,consrate:args.crbo2, transit: args.trbo2}),mhs:args.mhs, lt:60,transit: args.trbo2, consrate:args.crbo2}), paymentDueDate: paymentDue("KDR", "inv2", "order"), amountDue: amountDue("bo2",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv3: {product: "BS150", Qty: data(args).bo3.sum.toFixed(2), /*Stockholding_period: shp({inv:args.bo3,consrate:args.crbo3}),*/leadtime: 60,supplier: "KDR",orderdate: orderdate({ hs: shp({inv:args.bo3,consrate:args.crbo3, transit: args.trbo3}),mhs:args.mhs, lt:60,transit: args.trbo3, consrate:args.crbo3}), paymentDueDate: paymentDue("KDR", "inv3", "order"), amountDue: amountDue("bo3",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv4: {product: "SN80/SN100", Qty: data(args).bo4.sum.toFixed(2), /*Stockholding_period: shp({inv:args.bo4,consrate:args.crbo4}),*/leadtime: 60,supplier: "Royal",orderdate: orderdate({ hs: shp({inv:args.bo4,consrate:args.crbo4, transit: args.trbo4}),mhs:args.mhs, lt:60,transit: args.trbo4, consrate:args.crbo4}), paymentDueDate: paymentDue("Royal", "inv4", "order"), amountDue: amountDue("bo4",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv5: {product: "DPK", Qty: data(args).bo5.sum.toFixed(2), /*Stockholding_period: shp({inv:args.bo5,consrate:args.crbo5}),*/leadtime: 60,supplier: "Royal",orderdate: orderdate({ hs: shp({inv:args.bo5,consrate:args.crbo5, transit: args.trbo5}),mhs:args.mhs, lt:60,transit: args.trbo5, consrate:args.crbo5}), paymentDueDate: paymentDue("Royal", "inv5", "order"), amountDue: amountDue("bo5",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},

        inv6: {product: "TBN+", Qty: data(args).ad1.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad1,consrate:args.crad1, transit: args.trad1}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv6", "order"), amountDue: amountDue("ad1",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv7: {product: "PPD", Qty: data(args).ad2.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad2,consrate:args.crad2, transit: args.trad2}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv7", "order"), amountDue: amountDue("ad2",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv8: {product: "CI-4", Qty: data(args).ad3.sum.toFixed(2), leadtime: 40, supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad3,consrate:args.crad3, transit: args.trad3}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv8", "order"), amountDue: amountDue("ad3",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv9: {product: "BS200", Qty: data(args).ad4.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad4,consrate:args.crad4, transit: args.trad4}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv9", "order"), amountDue: amountDue("ad4",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv10: {product: "VII", Qty: data(args).ad5.sum.toFixed(2), leadtime: 40,supplier: "Blackbull",orderdate: orderdate({hs: shp({inv:args.ad5,consrate:args.crad5, transit: args.trad5}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("Blackbull", "inv10", "order"), amountDue: amountDue("ad5",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv11: {product: "MONO PA EO", Qty: data(args).ad6.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad6,consrate:args.crad6, transit: args.trad6}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv11", "order"), amountDue: amountDue("ad6",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv12: {product: "4T PA PEO", Qty: data(args).ad7.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad7,consrate:args.crad7, transit: args.trad7}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv12", "order"), amountDue: amountDue("ad7",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv13:{product: "ATF PA", Qty: data(args).ad8.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad8,consrate:args.crad8, transit: args.trad8}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv13", "order"), amountDue: amountDue("ad8",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv14:{product: "2T PA", Qty: data(args).ad9.sum.toFixed(2), leadtime: 40,supplier: "KDR",orderdate: orderdate({hs: shp({inv:args.ad9,consrate:args.crad9, transit: args.trad9}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("KDR", "inv14", "order"), amountDue: amountDue("ad9",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv15:{product: "HYA", Qty: data(args).ad10.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad10,consrate:args.crad10, transit: args.trad10}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv15", "order"), amountDue: amountDue("ad10",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv16:{product: "DYE", Qty: data(args).ad11.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad11,consrate:args.crad11, transit: args.trad11}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv16", "order"), amountDue: amountDue("ad11",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })},
        inv17:{product: "TURB", Qty: data(args).ad12.sum.toFixed(2), leadtime: 40,supplier: "IMCD",orderdate: orderdate({hs: shp({inv:args.ad12,consrate:args.crad12, transit: args.trad12}), mhs:args.mhs, lt:40}), paymentDueDate: paymentDue("IMCD", "inv17", "order"), amountDue: amountDue("ad12",1).toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
    }
    useEffect(()=>{
