...
function Graph3(props){
    ...
    var shp = (obj)=>{
        ...
        let result = (((inv + transit) / consrate)).toFixed(1);//OPTION A
        return result;
    }
    ...
    const testAccess = async () => {
        ...
        if(currentUser.email === "ellisrgrz@gmail.com"){
            return true
        }
        else {
            return false
    ...
    {
        return {product: true, inventory: false, transit: false, consumption:true}
    })
    var buttonsize = "md";
    var initdate = new Date();
    var prod_table_columns = ["Products", "Quantity (Tons)", "Maximize"]
    var prod_table_data = {
        prod1: {col1: "2T", col2: <NumberInp access={access.product} value={args._2T} prod="_2T" onChange={prodtable} init={args._2T} />, col4: <Button size={buttonsize} id='max' name='_2T' onClick={tablebutton}>Set Max</Button>},
        prod2: {col1: "4T", col2: <NumberInp access={access.product} value={args._4T} prod="_4T" onChange={prodtable} init={args._4T} />, col4: <Button size={buttonsize} id='max' name='_4T' onClick={tablebutton}>Set Max</Button>},
        prod3: {col1: "ATF III", col2: <NumberInp access={access.product} value={args.atfIII} prod="atfIII" onChange={prodtable} init={args.atfIII} />, col4: <Button size={buttonsize} id='max' name='atfIII' onClick={tablebutton}>Set Max</Button>},
        prod4: {col1: "Duramax HD", col2: <NumberInp access={access.product} value={args.DuramaxHD} prod="DuramaxHD" onChange={prodtable} init={args.DuramaxHD} />, col4: <Button size={buttonsize} id='max' name='DuramaxHD' onClick={tablebutton}>Set Max</Button>},
        prod5: {col1: "Frontia X", col2: <NumberInp access={access.product} value={args.FrontiaX} prod="FrontiaX" onChange={prodtable} init={args.FrontiaX} />, col4: <Button size={buttonsize} id='max' name='FrontiaX' onClick={tablebutton}>Set Max</Button>},
        prod6: {col1: "GEO 80W90", col2: <NumberInp access={access.product} value={args.Geo80W90} prod="Geo80W90" onChange={prodtable} init={args.Geo80W90} />, col4: <Button size={buttonsize} id='max' name='Geo80W90' onClick={tablebutton}>Set Max</Button>},
        prod7: {col1: "GEO 85W140", col2: <NumberInp access={access.product} value={args.Geo85W140} prod="Geo85W140" onChange={prodtable} init={args.Geo85W140} />, col4: <Button size={buttonsize} id='max' name='Geo85W140' onClick={tablebutton}>Set Max</Button>},
        prod8: {col1: "Hydrax 32", col2: <NumberInp access={access.product} value={args.Hydrax32} prod="Hydrax32" onChange={prodtable} init={args.Hydrax32} />, col4: <Button size={buttonsize} id='max' name='Hydrax32' onClick={tablebutton}>Set Max</Button>},
        prod9: {col1: "Hydrax Z 46", col2: <NumberInp access={access.product} value={args.HydraxZ46} prod="HydraxZ46" onChange={prodtable} init={args.HydraxZ46} />, col4: <Button size={buttonsize} id='max' name='HydraxZ46' onClick={tablebutton}>Set Max</Button>},
        prod10: {col1: "Hydrax Z 68", col2: <NumberInp access={access.product} value={args.HydraxZ68} prod="HydraxZ68" onChange={prodtable} init={args.HydraxZ68} />, col4: <Button size={buttonsize} id='max' name='HydraxZ68' onClick={tablebutton}>Set Max</Button>},
        prod11: {col1: "Power Trans SP 150", col2: <NumberInp access={access.product} value={args.PowerTransSP150} prod="PowerTransSP150" onChange={prodtable} init={args.PowerTransSP150} />, col4: <Button size={buttonsize} id='max' name='PowerTransSP150' onClick={tablebutton}>Set Max</Button>},
        prod12: {col1: "Power Trans SP 220", col2: <NumberInp access={access.product} value={args.PowerTransSP220} prod="PowerTransSP220" onChange={prodtable} init={args.PowerTransSP220} />, col4: <Button size={buttonsize} id='max' name='PowerTransSP220' onClick={tablebutton}>Set Max</Button>},
        prod13: {col1: "Power Trans SP 320", col2: <NumberInp access={access.product} value={args.PowerTransSP320} prod="PowerTransSP320" onChange={prodtable} init={args.PowerTransSP320} />, col4: <Button size={buttonsize} id='max' name='PowerTransSP320' onClick={tablebutton}>Set Max</Button>},
        prod14: {col1: "SB 22 D210", col2: <NumberInp access={access.product} value={args.Sb22D210} prod="Sb22D210" onChange={prodtable} init={args.Sb22D210} />, col4: <Button size={buttonsize} id='max' name='Sb22D210' onClick={tablebutton}>Set Max</Button>},
        prod15: {col1: "Sentry HD Sae 40", col2: <NumberInp access={access.product} value={args.SentryHDSae40} prod="SentryHDSae40" onChange={prodtable} init={args.SentryHDSae40} />, col4: <Button size={buttonsize} id='max' name='SentryHDSae40' onClick={tablebutton}>Set Max</Button>},
        prod16: {col1: "Turbofleet Sae 15W", col2: <NumberInp access={access.product} value={args.TurbofleetSae15W} prod="TurbofleetSae15W" onChange={prodtable} init={args.TurbofleetSae15W} />, col4: <Button size={buttonsize} id='max' name='TurbofleetSae15W' onClick={tablebutton}>Set Max</Button>},
    ...
    var inv_table_data = {
        inv1: {col1: "500SN/600N", col2: data(args).bo1.sum.toFixed(2), col3: <NumberInp access={access.inventory} prod="bo1" init={args.bo1} onChange={inv_table} value={args.bo1} />,transit: <NumberInp access={access.transit} prod="trbo1" init={args.trbo1} onChange={inv_table} value={args.trbo1} />, consrate:<NumberInp access={access.consumption} prod="crbo1" init={args.crbo1} onChange={inv_table} value={args.crbo1}/>, hs: shp({inv:args.bo1,consrate:args.crbo1, transit: args.trbo1}), col4: 60, order: orderdate({ hs: shp({inv:args.bo1,consrate:args.crbo1, transit: args.trbo1}),mhs:args.mhs, lt:60,transit: args.trbo1, consrate:args.crbo1}), col5: (args.bo1 - data(args).bo1.sum).toFixed(2)},
        inv2: {col1: "150SN", col2: data(args).bo2.sum.toFixed(2), col3: <NumberInp access={access.inventory} prod="bo2" init={args.bo2} onChange={inv_table} value={args.bo2} />,transit: <NumberInp access={access.transit} prod="trbo2" init={args.trbo2} onChange={inv_table} value={args.trbo2} />, consrate:<NumberInp access={access.consumption} prod="crbo2" init={args.crbo2} onChange={inv_table} value={args.crbo2}/>, hs: shp({inv:args.bo2,consrate:args.crbo2, transit: args.trbo2}),col4: 60,order: orderdate({ hs: shp({inv:args.bo2,consrate:args.crbo2, transit: args.trbo2}),mhs:args.mhs, lt:60,transit: args.trbo2, consrate:args.crbo2}),col5: (args.bo2 - data(args).bo2.sum).toFixed(2)},
        inv3: {col1: "BS150", col2: data(args).bo3.sum.toFixed(2), col3: <NumberInp access={access.inventory} prod="bo3" init={args.bo3} onChange={inv_table} value={args.bo3} />,transit: <NumberInp access={access.transit} prod="trbo3" init={args.trbo3} onChange={inv_table} value={args.trbo3} />, consrate:<NumberInp access={access.consumption} prod="crbo3" init={args.crbo3} onChange={inv_table} value={args.crbo3}/>,hs: shp({inv:args.bo3,consrate:args.crbo3, transit: args.trbo3}),col4: 60,order: orderdate({ hs: shp({inv:args.bo3,consrate:args.crbo3, transit: args.trbo3}),mhs:args.mhs, lt:60,transit: args.trbo3, consrate:args.crbo3}),col5: (args.bo3 - data(args).bo3.sum).toFixed(2)},
        inv4: {col1: "SN80/SN100", col2: data(args).bo4.sum.toFixed(2), col3: <NumberInp access={access.inventory} prod="bo4" init={args.bo4} onChange={inv_table} value={args.bo4} />,transit: <NumberInp access={access.transit} prod="trbo4" init={args.trbo4} onChange={inv_table} value={args.trbo4} />, consrate:<NumberInp access={access.consumption} prod="crbo4" init={1} onChange={inv_table} value={args.crbo4}/>, hs: shp({inv:args.bo4,consrate:args.crbo4, transit: args.trbo4}),col4: 60,order: orderdate({ hs: shp({inv:args.bo4,consrate:args.crbo4, transit: args.trbo4}),mhs:args.mhs, lt:60,transit: args.trbo4, consrate:args.crbo4}),col5: (args.bo4 - data(args).bo4.sum).toFixed(2)},
    ...
    return (
        <div>
            ...
            {/* {numberStateful} */}
            <Button isDisabled={testAccess()} onClick={()=>{localStorage.clear()}}>clear local storage</Button>
